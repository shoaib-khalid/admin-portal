...
class RefundHistoryExport implements FromCollection, ShouldAutoSize, WithHeadings
{
    ...
    */
    ...
    {
       $datas = Refund::select('orderId','invoiceId', 'store.name AS storeName', 'customer.name AS customerName', 'refundType','refundAmount','paymentChannel','refundStatus','remarks', 'refunded')
