            ...
            <div class="row">
                <div class="col">
                    ...
                    <form action="/filter_settlement" method="post" enctype="multipart/form-data" accept-charset='UTF-8'>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="date_chosen3" id="date_chosen3" class="form-control daterange-btn3" value="{{$datechosen}}">
                ...
                <div class="col">
                    <form action="/export_settlement" method="post" enctype="multipart/form-data" accept-charset='UTF-8'>
                        {{@csrf_field()}}
                        <input type="text" name="date_chosen3_copy" id="date_chosen3_copy" class="form-control daterange-btn3" value="{{$datechosen}}" hidden>
