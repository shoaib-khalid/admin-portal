<x-app-layout>
    ...
    <div>
        <x-featuredstore-table :datas="$datas" :storename="$storename" :searchresult="$searchresult" :categorylist="$categorylist" :categoryselected="$categoryselected"></x-featuredstore-table>
    </div>
</x-app-layout>
<script>
