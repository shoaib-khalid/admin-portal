<x-app-layout>
    ...
    <div>
        <x-useractivitysummary-table :datas="$datas" :datechosen="$datechosen" :storename="$storename" :customername="$customername" :device="$device" :browser="$browser" :groupbrowser="$groupbrowser" :groupdevice="$groupdevice" :groupos="$groupos" :grouppage="$grouppage"></x-useractivitysummary-table>
    </div>
</x-app-layout>
<script>
