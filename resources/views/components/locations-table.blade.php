       ...
       <div class="form-group">
        ...
        <div class="row">
            <div class="col">
                ...
                <form action="add_location" method="post" enctype="multipart/form-data" accept-charset='UTF-8'>                                        
                        ...
                        <div class="input-group mb-3">                        
                            <div class="col-10">
                                @if(checkPermission('add_location','POST')) 
        ...
        <div class="input-group mb-3">  
                <div class="col-5"></div>
                    ...
                    <form action="filter_citylocation" method="post" enctype="multipart/form-data" accept-charset='UTF-8'>
                    {{@csrf_field()}}  
                        <div class="input-group mb-3">
                ...
                <tbody id="areaList">
                    ...
                    @foreach ($datas as $data)
                        <tr class="text-center">
                            ...
                            <td>
                                        @if(checkPermission('edit_location','POST')) 
                            ...
                            <td>
                                 <form action="delete_location" method="post" enctype="multipart/form-data" accept-charset='UTF-8'>
                                    {{@csrf_field()}}
                                     ...
                                     @if(checkPermission('delete_location','POST')) 
